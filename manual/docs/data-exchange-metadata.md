...
|Format|Categorical: 0=Unknown; 1=No; 2=Planned; 3=Piloting; 4 =Functional across at least 2 systems|
...
|Field|Value|
|-|-|
|Variable|exchange-system-operational|
|Definition|Current operational status of the data exchange system|
|Format|Categorical: 0=Unknown; 1=Not Established; 2=Planned; 3=Under Development; 4=Partially Operational; 5=Fully Operational|
...
|Field|Value|
|-|-|
|Variable|exchange-gov-strategy|
...
|Format|Categorical: 0=Unknown; 1=No; 2= Under development; 3 = Yes|
...
|Field|Value|
|-|-|
|Variable|exchange-func-digitalid|
...
|Field|Value|
|-|-|
|Variable|exchange-func-payments|
...
|Field|Value|
|-|-|
|Variable|exchange-func-revenue|
...
|Field|Value|
|-|-|
|Variable|exchange-func-electoral|
...
|Field|Value|
|-|-|
|Variable|exchange-func-passport|
...
|Field|Value|
|-|-|
|Variable|exchange-func-licensing|
...
|Field|Value|
|-|-|
|Variable|exchange-func-education|
...
|Field|Value|
|-|-|
|Variable|exchange-func-socialprotection|
...
|Field|Value|
|-|-|
|Variable|exchange-func-agriculture|
...
|Field|Value|
|-|-|
|Variable|exchange-func-justice|
...
|Field|Value|
|-|-|
|Variable|exchange-func-employment|
...
|Field|Value|
|-|-|
|Variable|exchange-func-business|
...
|Field|Value|
|-|-|
|Variable|exchange-uptake-subnational|
|Definition|Extent to which provincial/state and local governments participate in the data exchange|
|Format|Categorical: 0=Unknown; 1=National level only; 2=Planned; 3=Under development; 4=Partial Participation; 5=Full Participation|
|Other Metadata|Provide details in Comments|
...
|Field|Value|
|-|-|
|Variable|exchange-incl-accessibility|
...
|Format|Categorical: 0=Unknown; 1=Limited accessibility; 2=Partial accessibility; 3=Accessibility improvements in progress; 4=Full accessibility|
|Other Metadata|Provide details in Comments|
...
|Field|Value|
|-|-|
|Variable|exchange-incl-urbanrural|
...
|Format|Categorical: 0=Unknown; 1=Primarily urban; 2=Partial rural coverage; 3=Equitable Urban=Rural Coverage|
|Other Metadata|Provide details in Comments|
...
|Field|Value|
|-|-|
|Variable|exchange-cred-sovereignty|
|Definition|Provisions ensuring national control over government data and protecting against unauthorized foreign access|
|Format|Categorical: 0=Unknown; 1=No controls; 2=Limited controls; 3=Strong yet unenforced controls; 4=Strong, enforced controls|
...
|Field|Value|
|-|-|
|Variable|exchange-gov-legislation-exists|
